...
func (Controller Controller) AddUserjrny(c echo.Context) error {
	...
	if addUserjrny {
		...
		getadd := Userjrnyget{a.Email, a.Id_dataflow, a.Journey_name, a.Initiate_state, a.Journey_link, a.Journey_index}
...
//view userjourney by dataflow structure
